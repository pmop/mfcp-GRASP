...
def greedy_random_solution(height, demand_points, radius):
    sol = []
    ...
    while len(uncovered_demand) > 0:
        ...
        sol_ = generate_random_points(leftmost_demand, height, p)
...
def simul():
    ...
    sol = greedy_random_solution(460, demand_points, radius)
